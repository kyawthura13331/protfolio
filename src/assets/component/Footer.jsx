...
const Footer = () => {
  return (
  <div>
          <div className="flex gap-5  text-2xl mt-10 pb-2">
          ...
          <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:text-black scale-120">
            <svg fill="currentColor" viewBox="0 0 48 48" className="scale-120 w-7 h-7">
        ...
        <div className="text-xs sm:text-xl text-gray-400 text-center mt-2">
